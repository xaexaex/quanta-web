...
const footerColumns = [
  ...
  },
  {
    heading: "Company",
    links: [
      { label: "Quantalabs", href: "https://quantalabs.cc", external: true },
  ...
  },
  {
    heading: "Contact",
    links: [
      { label: "Partnerships", href: "mailto:contact@quantachain.org" },
      { label: "General Inquiries", href: "mailto:info@quantachain.org" },
      { label: "Discord", href: "https://discord.gg/7KmMBrrJEz", external: true },
      { label: "Telegram", href: "https://t.me/quantanetwork", external: true },
    ],
  },
];
      ...
      <div className="border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex flex-col sm:flex-row gap-3 shrink-0">
            ...
            >
              Get QUA <ArrowUpRight className="w-4 h-4" />
            </Link>
            <a
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
          ...
          <div className="lg:col-span-3">
            ...
            <p className="text-gray-500 text-sm leading-relaxed mb-6 max-w-xs">
              Quantum-resistant blockchain built with NIST-standardized post-quantum cryptography
              for the next era of secure decentralized applications.
            </p>
                  ...
                  {col.links.map((link) => (
                    <li key={link.label} className="flex items-center gap-2">
                      ...
                      {(link as { badge?: string }).badge && (
                        <span className={`text-[10px] font-black px-1.5 py-0.5 rounded-full leading-none ${(link as { badge?: string }).badge === "Live"
                            ? "bg-green-50 text-green-700 border border-green-100"
                            : (link as { badge?: string }).badge === "Building"
      ...
      <div className="border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="font-mono text-xs text-gray-400">
            © {new Date().getFullYear()} Quanta Chain. All rights reserved.
          </p>
          <div className="flex flex-wrap justify-center gap-x-6 gap-y-2 text-xs text-gray-400">
            <Link href="/privacy" className="hover:text-black transition-colors">Privacy Policy</Link>
            <Link href="/terms" className="hover:text-black transition-colors">Terms of Service</Link>
            <a href="mailto:contact@quantachain.org" className="hover:text-black transition-colors">contact@quantachain.org</a>
          </div>
        </div>
      </div>
