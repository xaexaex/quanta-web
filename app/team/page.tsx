    ...
    <main className="min-h-screen bg-white text-black">
      ...
      <div className="pt-32 pb-24">
        <div className="container mx-auto px-6">
          ...
          <div className="max-w-4xl mx-auto mb-24 bg-gradient-to-br from-gray-50 to-white border-2 border-gray-100 rounded-3xl p-10">
            <h2 className="text-3xl md:text-4xl font-bold mb-8">Project Transparency</h2>
            <div className="space-y-6">
              <div className="border-l-4 border-[#00E599] pl-6">
                <h3 className="font-bold text-xl mb-2">Funding Status</h3>
              ...
              <div className="border-l-4 border-[#00E599] pl-6">
                <h3 className="font-bold text-xl mb-2">Development Progress</h3>
                <p className="text-gray-700">
              ...
              <div className="border-l-4 border-[#00E599] pl-6">
                <h3 className="font-bold text-xl mb-2">Audits & Security</h3>
                <p className="text-gray-700">
              ...
              <div className="border-l-4 border-[#00E599] pl-6">
                <h3 className="font-bold text-xl mb-2">Open Source Commitment</h3>
                <p className="text-gray-700">
